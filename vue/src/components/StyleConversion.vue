...
<!--<template xmlns:v-bind="http://www.w3.org/1999/xhtml">-->
<!--  <header-bar></header-bar>-->
<!--&lt;!&ndash;   <div class="centered-container">&ndash;&gt;-->
<!--&lt;!&ndash;    <el-select v-model="value" placeholder="请选择要转换的图片风格" class="custom-select"  >&ndash;&gt;-->
...
<!--      </option>-->
<!--    </select>-->
<!--&lt;!&ndash;    <p v-if="selectedOption">当前选中的是: {{ selectedOption }}</p>&ndash;&gt;-->
<!--  </div>-->

<!--&lt;!&ndash;    <input type="file" @change="handleWeightFileUpload">&ndash;&gt;-->
<!--    <img :src="originalImageUrl" v-if="originalImageUrl" alt="Uploaded Image">-->
...
<!--    <p>转换结果:{{prediction}}</p>-->
<!--    <span>{{  }}</span>-->
<!--&lt;!&ndash;<img src='../output_img/alexandrite_18.jpg' alt="Prediction Image">&ndash;&gt;-->
<!--&lt;!&ndash;<img v-bind:src="'../output_img/' + predictionImagename" alt="裂开了">&ndash;&gt;-->
<!--&lt;!&ndash;<img v-bind:src="` vue/public/static/output_img/${predictionImagename} `" alt="裂开了">&ndash;&gt;-->
<!--&lt;!&ndash;<img v-bind:src="` vue/public/static/output_img/${predictionImagename} `" alt="裂开了">&ndash;&gt;-->
...
<!--&lt;!&ndash;<p>Message: {{ `vue/public/static/output_img/${predictionImagename}` }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;    <img :src=" '../../transfers/output_img' + prediction" v-if=" '../../../transfers/output_img' + prediction" alt="prediction Image">&ndash;&gt;-->
<!--&lt;!&ndash;    <img :src='D:\\github\\Gem-recognition\\transfers\\output_img\\alexandrite_3.jpg' v-if="prediction" alt="prediction Image">&ndash;&gt;-->

<!--&lt;!&ndash;    <div >&ndash;&gt;-->
<!--&lt;!&ndash;      <div >&ndash;&gt;-->
<!--&lt;!&ndash;        <img :src="'data:image;base64,'+image">&ndash;&gt;-->
<!--&lt;!&ndash;      </div>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->
<!--  </div>-->
<!--  <footer-bar></footer-bar>-->
